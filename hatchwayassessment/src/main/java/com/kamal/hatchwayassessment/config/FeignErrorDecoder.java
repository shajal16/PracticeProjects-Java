package com.kamal.hatchwayassessment.config;

import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.kamal.hatchwayassessment.services.responses.FeignCustomMessage;
...
public class FeignErrorDecoder implements ErrorDecoder {
    ...
    @Override public Exception decode(String methodKey, Response response) {
        ...
        try {
            ...
            FeignCustomMessage exceptionMessage = mapper.readValue(result,
                    FeignCustomMessage.class);
        ...
        switch (response.status()) {
            case 400:
                ...
                //handle exception
                return new Exception("Tags parameter is required");
            case 401:
                log.error("Error in request went through feign client {} ", erroMessage);
                //handle exception
